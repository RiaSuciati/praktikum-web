...
Tampilkan Data : <select name="jum">
<option value="1" <?php $jum=(isset($_POST['jum'])?$_POST['jum']:1) ; echo 'selected = "selected"'; ?>}>1</option>
<option value="2" <?php $jum=(isset($_POST['jum'])?$_POST['jum']:2) ; echo 'selected = "selected"'; ?>}>2</option>
<option value="3" <?php $jum=(isset($_POST['jum'])?$_POST['jum']:3) ; echo 'selected = "selected"'; ?>}>3</option>
